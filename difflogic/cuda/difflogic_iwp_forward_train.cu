...
__global__ void iwp_logic_layer_cuda_forward_kernel(
...
torch::Tensor iwp_logic_layer_cuda_forward(
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(x.scalar_type(), "iwp_logic_layer_cuda_forward", ([&] {
                           iwp_logic_layer_cuda_forward_kernel<scalar_t><<<blocks_per_grid, threads_per_block>>>(
